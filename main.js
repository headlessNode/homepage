...
___CSS_LOADER_EXPORT___.push([module.id, `body{
    background: red;
}`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,eAAe;AACnB","sourcesContent":["body{\n    background: red;\n}"],"sourceRoot":""}]);
// Exports
